defmodule BudgetTracker.Accounts.User do
  ...
  schema "users" do
    ...
    field :currency, :string, default: "PHP"
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, BudgetTracker.Repo)
  ...
  """
  def valid_password?(%BudgetTracker.Accounts.User{hashed_password: hashed_password}, password)
