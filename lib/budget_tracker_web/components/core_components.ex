defmodule BudgetTrackerWeb.CoreComponents do
  @moduledoc """
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-brand hover:bg-brand/80 py-2 px-3",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BudgetTrackerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BudgetTrackerWeb.Gettext, "errors", msg, opts)
    end
  end
